...
- **`tools/yardb_mcp.py` / `tools/yardb_mcp_sse.py`** - MCP bridges (stdio or HTTP/SSE) for agents/IDEs (see [programs.md](programs.md#mcp-bridge---cursor--agent-client); smoke: `./tests/mcp/smoke.sh`)
