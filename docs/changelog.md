...
| **MCP SSE loopback peer gate** | When `YARDB_MCP_SSE_HOST` is loopback, non-loopback clients are refused — closes `uvicorn … --host 0.0.0.0` Host-spoof of the PAT-injecting CRUD proxy |
